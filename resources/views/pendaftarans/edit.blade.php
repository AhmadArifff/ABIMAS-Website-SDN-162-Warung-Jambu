            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="text-center mt-3 mb-5">Edit Pendaftaran</h3>
                        
                        <div class="row">
                            <div class="col-3 mt-4">
                                <div class="card shadow" >
                                    <img src="{{asset('pendaftaran_image/'.$pendaftaran->image)}}" class="card-img-top" alt="image">
                                </div>
                            </div>
                            <div class="col-9">
                                <form action="{{route('pendaftarans.update', [$pendaftaran->id])}}" method="POST" class="d-inline" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <p>Caption:</p>
                                    <p>
                                    <textarea name="caption" id="content" rows="10" class="form-control ckeditor" >{{$pendaftaran->caption}}</textarea>
                                    </p>
                                    <div class="row">
