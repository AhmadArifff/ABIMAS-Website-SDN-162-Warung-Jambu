...
@section('title', "Edit Berita $menu")
...
<div class="row">
	<div class="col-md-12">
		<div class="card shadow">
			<div class="card-body">
				<form action="{{route('admin.berita.update', $berita->b_id)}}" method="POST" enctype="multipart/form-data">
					@csrf
					@method('PUT')
					@if ($errors->any())
					...
					<div class="col-10">
						...
						<div class="mb-3">
							...
							<input type="text" name="b_nama_berita" id="b_nama_berita" placeholder="Nama Berita..." class="form-control {{$errors->first('b_nama_berita') ? "is-invalid" : ""}}" value="{{$berita->b_nama_berita}}" required>
						...
						<div class="mb-3">
							...
							<textarea name="b_deskripsi_berita" id="b_deskripsi_berita" placeholder="Deskripsi Berita..." class="form-control {{$errors->first('b_deskripsi_berita') ? "is-invalid" : ""}}" required>{{$berita->b_deskripsi_berita}}</textarea>
								...
								<div class="row" id="activity-cards">
									<div class="col-md-12 mb-4 activity-card" data-page="1" style="transition: transform 0.3s, opacity 0.3s;">
										<div class="card d-flex flex-row align-items-center">
											<img id="preview-image" src="{{ asset('berita_image/' .$berita->b_foto_berita) }}" class="card-img-top" alt="Preview Image" style="height: 250px; object-fit: cover; width: 40%; image-rendering: optimizeSpeed;">
											<div class="card-body">
												<h5 class="card-title" id="preview-title">{{$berita->b_nama_berita}}</h5>
												<p class="card-text" id="preview-description">{{ Str::limit($berita->b_deskripsi_berita, 500) }}</p>
